            ...
            >
              ...
              <div className="flex justify-center gap-2 mb-3">
                ...
                <div
                  ...
                  className="relative w-14 h-14 rounded-full bg-amber-600 border-2 border-amber-800 flex items-center justify-center text-white font-bold text-sm shadow-lg hover:scale-110 transition-transform cursor-grab active:cursor-grabbing overflow-hidden"
                  title="Entrenador - Arrastra para asignar tarjeta"
                >
                ...
                <div
                  ...
                  className="relative w-14 h-14 rounded-full bg-amber-600 border-2 border-amber-800 flex items-center justify-center text-white font-bold text-sm shadow-lg hover:scale-110 transition-transform cursor-grab active:cursor-grabbing overflow-hidden"
                  title="Delegado - Arrastra para asignar tarjeta"
                >
                ...
                <div
                  ...
                  className="relative w-14 h-14 rounded-full bg-amber-600 border-2 border-amber-800 flex items-center justify-center text-white font-bold text-sm shadow-lg hover:scale-110 transition-transform cursor-grab active:cursor-grabbing overflow-hidden"
                  title="Auxiliar - Arrastra para asignar tarjeta"
                >
            ...
            <div className="flex-1 flex flex-col gap-4">
              ...
              <div className="flex justify-center items-center gap-3">
                ...
                <div
                  ...
                  className="w-24 h-[74px] bg-green-500 hover:bg-green-600 text-white font-bold rounded-lg shadow-lg transition-all hover:scale-105 flex flex-col items-center justify-center gap-2 cursor-pointer border-2 border-transparent hover:border-white"
                >
                  <svg
                    className="w-12 h-12"
                    fill="currentColor"
                ...
                <div
                  ...
                  className="w-24 h-[74px] bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-lg shadow-lg transition-all hover:scale-105 flex flex-col items-center justify-center gap-2 cursor-pointer border-2 border-transparent hover:border-white"
                >
                  <svg
                    className="w-10 h-10"
                    fill="none"
                ...
                <div
                  ...
                  className="w-24 h-[74px] bg-yellow-400 hover:bg-yellow-500 text-gray-800 font-bold rounded-lg shadow-lg transition-all hover:scale-105 flex flex-col items-center justify-center gap-2 cursor-pointer border-2 border-transparent hover:border-gray-800"
                >
                  <svg
                    className="w-10 h-10"
                    fill="currentColor"
                ...
                <div
                  ...
                  className="w-24 h-[74px] bg-red-500 hover:bg-red-600 text-white font-bold rounded-lg shadow-lg transition-all hover:scale-105 flex flex-col items-center justify-center gap-2 cursor-pointer border-2 border-transparent hover:border-white"
                >
                  <svg
                    className="w-10 h-10"
                    fill="currentColor"
            ...
            >
              ...
              <div className="flex justify-center gap-2 mb-3">
                ...
                <div
                  ...
                  className="relative w-14 h-14 rounded-full bg-amber-600 border-2 border-amber-800 flex items-center justify-center text-white font-bold text-sm shadow-lg hover:scale-110 transition-transform cursor-grab active:cursor-grabbing overflow-hidden"
                  title="Entrenador Visitante - Arrastra para asignar tarjeta"
                >
                ...
                <div
                  ...
                  className="relative w-14 h-14 rounded-full bg-amber-600 border-2 border-amber-800 flex items-center justify-center text-white font-bold text-sm shadow-lg hover:scale-110 transition-transform cursor-grab active:cursor-grabbing overflow-hidden"
                  title="Delegado Visitante - Arrastra para asignar tarjeta"
                >
                ...
                <div
                  ...
                  className="relative w-14 h-14 rounded-full bg-amber-600 border-2 border-amber-800 flex items-center justify-center text-white font-bold text-sm shadow-lg hover:scale-110 transition-transform cursor-grab active:cursor-grabbing overflow-hidden"
                  title="Auxiliar Visitante - Arrastra para asignar tarjeta"
                >
                  ...
                  {[1, 2, 3, 4].map((numero) => {
                    ...
                    return (
                      <div
                        ...
                        onClick={() => setEditandoDorsal(numero)}
                        className="relative w-14 h-14 rounded-full bg-white border-2 border-gray-400 flex items-center justify-center text-gray-700 font-bold text-base shadow-lg hover:scale-110 hover:border-blue-500 transition-transform overflow-hidden"
                        style={{
                          cursor: editandoDorsal === numero ? "text" : "grab",
                        }}
                        title={
